...
const columns = [
  ...
  { id: "category_name", label: "Tên danh mục", minWidth: 170, type: "text" },
  { id: "category_code", label: "Code", minWidth: 170, type: "text" },
  {
    id: "quantity_sold",
    label: "Đơn vị đã bán",
    minWidth: 170,
...
const renderActions = (id) => {
  return (
    <TableCell component="th" scope="row">
      <IconButton>
        <Link to={`/admin/report/view-category/${id}`}>
...
export default function ReportCategory(props) {
  ...
  return (
    <div>
      <h2 className="page-header">Thống kê danh mục sản phẩm</h2>
      <div className="row">
