...
import { reportByBrand } from "services/ReportServices";
...
const columns = [
  ...
  { id: "brand_name", label: "Tên thương hiệu", minWidth: 170, type: "text" },
  { id: "brand_code", label: "Code", minWidth: 170, type: "text" },
  {
    id: "quantity_sold",
    label: "Đơn vị đã bán",
    minWidth: 170,
...
const renderActions = (id) => {
  return (
    <TableCell component="th" scope="row">
      <IconButton>
        <Link to={`/admin/report/view-brand/${id}`}>
...
export default function ReportBrand(props) {
  ...
  return (
    <div>
      <h2 className="page-header">Thống kê thương hiệu sản phẩm</h2>
      <div className="row">
