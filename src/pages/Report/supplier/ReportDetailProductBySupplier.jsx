...
import { reportDetailProductBySupplier } from "services/ReportServices";
...
export default function ReportDetailProductBySupplier(props) {
  ...
  const getData = useCallback(() => {
    ...
    reportDetailProductBySupplier(id, searchObj)
      .then((res) => {
