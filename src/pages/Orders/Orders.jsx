...
import { printInvoiceGHTK } from "services/GHTKServices";
...
const columns = [
  { id: "id", label: "Mã ĐH", numeric: true, minWidth: 100, isShow: true },
...
function Orders(props) {
  ...
  const handleSubmitOrder = (ship_type, order_code) => {
    setLoading(true);
    const data = {
